...
async def test_get_shards(tonlib_client: TonlibClient):
    ...
    try:
        ...
        shards = await tonlib_client.get_shards(
            master_seqno=masterchain_info["last"]["seqno"],
        )
...
async def test_get_transactions(tonlib_client: TonlibClient):
    ...
    try:
        ...
        txs = await tonlib_client.get_block_transactions(
            **masterchain_info["last"], count=10,
        )
